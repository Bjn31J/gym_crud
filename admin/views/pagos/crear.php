...
<div class="container mt-5">
    <h1 class="text-center mb-4">
        <?php if($accion == "crear"): echo("Nuevo "); else: echo("Modificar "); endif; ?> Pago
    </h1>
    <form action="pagos.php?accion=<?php if($accion=="crear"):echo('nuevo'); else: echo('modificar&id='.$id);endif;?>" method="post" class="bg-light p-5 rounded shadow-sm">
                ...
                <select name="data[id_cliente]" id="id_cliente" class="form-control" required>
                    ...
                    <?php foreach ($clientes as $cliente): ?>
                        <option value="<?php echo $cliente['id_cliente']; ?>" 
                            <?php if(isset($pago['id_cliente']) && $pago['id_cliente'] == $cliente['id_cliente']): echo 'selected'; endif; ?>>
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-sm-10">
                <input type="number" name="data[costo]" id="costo" class="form-control" 
                    value="<?php if(isset($pago['costo'])): echo $pago['costo']; endif; ?>" required/>
            </div>
        </div>
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-sm-10">
                <select name="data[tipo_plan]" id="tipo_plan" class="form-control" required>
                    ...
                    <option value="estándar" <?php if(isset($pago['tipo_plan']) && $pago['tipo_plan'] == 'estándar'): echo 'selected'; endif; ?>>Estándar</option>
                    <option value="personalizado" <?php if(isset($pago['tipo_plan']) && $pago['tipo_plan'] == 'personalizado'): echo 'selected'; endif; ?>>Personalizado</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-sm-10">
                <input type="date" name="data[fecha_pago]" id="fecha_pago" class="form-control" 
                    value="<?php if(isset($pago['fecha_pago'])): echo $pago['fecha_pago']; endif; ?>" required/>
            </div>
        </div>
